 ...
 $(document).ready(function () {
     $("#counter-html").counter({
         ...
         countFrom: 0,
         countTo: 75, // count to this number, default: 0
 ...
 $(document).ready(function () {
     $("#counter-mongodb").counter({
         ...
         duration: 2000, // milliseconds, default: 1500
         countFrom: 0,
         countTo: 25, // count to this number, default: 0
         runOnce: true, // only run the counter once, default: false
         placeholder: 0 + "%", // replace the number with this before counting,
         // most useful with autoStart: false. default: undefined
         easing: "easeOutCubic", // see http://gsgd.co.uk/sandbox/jquery/easing
 ...
 $(document).ready(function () {
     $("#counter-project-management").counter({
         autoStart: false, // true/false, default: true
         duration: 2000, // milliseconds, default: 1500
         countFrom: 0,
         countTo: 40, // count to this number, default: 0
 ...
 $(document).ready(function () {
     $(document).scroll(function () {
         ...
         if (top > 1850 && top < 3500) {
             $("#html, #css").animate({
                 width: "75%"
             }, 2000);
         } else {
             $("#html, #css").stop(true).animate({
                 width: "0"
             }, '2000');
         }
         ...
         if (top > 1850 && top < 3500) {
             ...
             $("#javascript").stop(true).animate({
                 width: "0"
             }, '2000');
         }
         if (top > 1850 && top < 4050) {
             $("#c").animate({
                 width: "20%"
             }, 2000);
         } else {
         ...
         if (top > 1850 && top < 3900) {
             $("#cplusplus").animate({
                 width: "30%"
             }, 2000);
         } else {
             $("#cplusplus").stop(true).animate({
                 width: "0"
             }, '2000');
         }

         if (top > 1850 && top < 3750) {
             $("#java").animate({
                 width: "60%"
             }, 2000);
         } else {
             $("#java").stop(true).animate({
                 width: "0"
             }, '2000');
         }
         ...
         if (top > 3200 && top < 4800) {
             ...
             $("#mis").stop(true).animate({
                 width: "0"
             }, '2000');
         }

         if (top > 3200 && top < 4800) {
             $("#it-life-cycle").animate({
                 width: "70%"
             }, 2000);
         } else {
             $("#it-life-cycle").stop(true).animate({
                 width: "0"
             }, '2000');
         }

         if (top > 3800 && top < 5400) {
             $("#financial-analysis").animate({
                 width: "30%"
             }, 2000);
         } else {
             $("#financial-analysis").stop(true).animate({
                 width: "0"
             }, '2000');
         }

         if (top > 3800 && top < 5500) {
             $("#project-management").animate({
                 width: "40%"
             }, 2000);
         } else {
             $("#project-management").stop(true).animate({
                 width: "0"
             }, '2000');
         }
